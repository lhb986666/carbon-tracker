RECOMMENDATIONS: dict[str, dict] = {
    ...
    "치킨": {
        "action": "포장 대신 매장 방문 또는 다회용기 활용",
        "alternative": "배달앱 대신 매장 방문 포장",
        "saving_ratio": 0.20,
        "tip": "배달 포장재 절감 시 월 약 4 kg CO₂ 절감",
    },
    "온라인쇼핑": {
        "action": "묶음 배송 활용",
    ...
    "대중교통": {
        "action": "이미 저탄소 수단을 이용 중입니다",
        "alternative": "도보·자전거 가능 구간은 추가로 대체해보세요",
        "saving_ratio": 0.05,
        "tip": "짧은 구간은 도보로 전환 시 추가 절감 가능",
    },
    "전기차충전": {
        "action": "이미 친환경 이동수단을 이용 중입니다",
        "alternative": "심야 시간대 충전 시 발전 효율 측면에서 더 유리",
        "saving_ratio": 0.05,
        "tip": "내연기관차 대비 이미 약 60% 이상 절감 중",
    },
    "의류": {
        "action": "중고 거래 또는 리폼 활용",
        "alternative": "번개장터·당근마켓 등 중고 거래 플랫폼 이용",
        "saving_ratio": 0.50,
        "tip": "의류 1벌 중고 구매 시 신품 대비 CO₂ 약 50% 절감",
    },
    "기타": {
        "action": "소비 내역 점검 및 불필요한 지출 줄이기",
        "alternative": "필요한 만큼만 구매하는 습관 들이기",
        "saving_ratio": 0.15,
        "tip": "충동구매를 줄이는 것만으로도 탄소 절감 효과",
    },
}
